...
const GuestContact = () => {  
  ...
  return (
    <div className="guest-contact" style={{ backgroundColor: '#d3f2ff' }}>
      <Grid container spacing={2} style={{ marginTop: '2px', padding: '20px'}}>
          <Grid item xs={12} lg={5} style={{ order: 2 }} >
          ...
          <Grid item xs={12} lg={7} style={{ position: 'sticky', top: '20px', order: 1 }}>
